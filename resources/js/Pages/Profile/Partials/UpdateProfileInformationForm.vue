...
const form = useForm({
    ...
    photo: null,
    precipitation_threshold: props.user.precipitation_threshold, // Default value
    uv_index_threshold: props.user.uv_index_threshold, // Default value
});
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <TextInput
                    ...
                    v-model="form.precipitation_threshold"
                    type="number"
                    class="mt-1 block w-full"
                    required
                    min="0"
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <TextInput
                    id="uv_index_threshold"
                    v-model="form.uv_index_threshold"
                    type="number"
                    class="mt-1 block w-full"
                    required
                    min="0"
